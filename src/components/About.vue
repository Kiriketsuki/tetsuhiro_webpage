<template>
    <div class = "flex lg:flex-row items-center justify-center lg:h-[85vh] flex-col lg:w-auto h-screen md:mt-10 sm:mt-10">
        <div class="background lg:[60vh] flex flex-col lg:flex-row rounded-xl">
            ...
            <div class = "lg:w-[50vw] lg:h-[60vh] h-auto shadow-lg flex flex-col items-center justify-center lg:text-3xl lg:gap-10 text-left rounded-lg font-roboto text-secondary">
                <p class = 'w-11/12'>
