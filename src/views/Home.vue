    ...
    <div>
        ...
        <div id = "home" class="w-screen flex flex-col items-center justify-between -z-10" style = "visibility: hidden">
            <section class = "h-screen w-full dodecahedron">
                <div class="h-full lg:w-1/2 bg-transparent z-10 flex flex-col items-center justify-center font-slab lg:text-[12rem] text-5xl text-secondary px-10 rounded-3xl w-full">
                    Welcome
